...
export default function TripPage() {
  ...
  const [formAutoOpened, setFormAutoOpened] = useState(false)
  ...
  useEffect(() => {
    if (tripLoading || formAutoOpened) return
    if (!trips.length) {
      setFormOpen(true)
      setFormAutoOpened(true)
    }
  }, [tripLoading, trips.length, formAutoOpened])

...
export default function TripPage() {
  ...
  return (
    <main className="min-h-screen px-[clamp(20px,5vw,64px)] pt-8 pb-[60px]">
      <div className="mx-auto max-w-4xl rounded-[24px] border border-[rgba(234,203,213,0.7)] bg-[linear-gradient(135deg,rgba(248,237,240,0.9),rgba(254,249,250,0.95))] px-8 py-12 shadow-[var(--shadow-soft)]">
        {/* Animated form section — rendered above trip list */}
        {trips.length ? (
          <div
            className="grid transition-[grid-template-rows] duration-300 ease-in-out"
            style={{
              gridTemplateRows: formVisible ? '1fr' : '0fr',
            }}
          >
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-xs font-semibold text-[color:var(--ink-600)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--sun-500)] focus-visible:outline-offset-[3px]"
                    >
                      Cancel
                    </button>
                  </div>
        ...
        {/* First-time user — no animation needed, form always visible */}
        {!trips.length ? (
          <>
            <div className="mb-8">
              <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              {!showForm ? (
                <button
                  type="button"
                  onClick={openForm}
                  className="hidden min-[900px]:inline-flex rounded-full border border-[color:var(--sand-300)] px-4 py-2 text-xs font-semibold text-[color:var(--ink-700)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--sun-500)] focus-visible:outline-offset-[3px]"
                >
                  New trip
                </button>
              ) : null}
        ...
        {/* Mobile FAB — fades in/out, matches itinerary "Add item" style */}
        {trips.length ? (
          <button
            type="button"
            onClick={openForm}
            className={`fixed bottom-6 right-6 z-[8] rounded-full bg-[color:var(--sun-400)] px-5 py-3 text-sm font-semibold text-[color:var(--ink-900)] shadow-lg transition-opacity duration-200 ease-in-out min-[900px]:hidden focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--sun-500)] focus-visible:outline-offset-[3px] ${
